...
singularity exec --nv deoxys-elasticdeform.sif python -u run_external.py $1 /mnt/SCRATCH2/$USER/canine/$2 --temp_folder /mnt/SCRATCH2/$USER/hnperf/$2 --analysis_folder /mnt/SCRATCH2/$USER/analysis/$2 ${@:3}