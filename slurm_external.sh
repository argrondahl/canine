...
singularity exec --nv deoxys-elasticdeform.sif python -u run_external.py $1 $SCRATCH2/canine/$2 --temp_folder $SCRATCH2/hnperf/$2 --analysis_folder $SCRATCH2/analysis/$2 ${@:3}