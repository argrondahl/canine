...
singularity exec --nv deoxys-elasticdeform.sif python transfer_learning.py $1 /mnt/SCRATCH2/canine/$2 --temp_folder /mnt/SCRATCH2/hnperf/$2 --analysis_folder /mnt/SCRATCH2/analysis/$2 --epochs $3 ${@:4}
